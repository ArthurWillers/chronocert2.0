<x-layouts.app>
    <div class="max-w-2xl mx-auto">
        ...
        <x-card>
            <h1 class="text-2xl font-bold text-neutral-900 mb-1">Novo Curso</h1>
            <p class="text-sm text-neutral-500 mb-6">Preencha as informações do curso e adicione as categorias de horas
                complementares.</p>

            <form method="POST" action="{{ route('courses.store') }}" x-data="{
                loading: false,
                categories: [{ name: '', max_hours: '' }],
                addCategory() {
                    this.categories.push({ name: '', max_hours: '' });
                },
                ...
                <div class="space-y-4">
                    ...
                    {{-- Total de horas --}}
                    <x-form-input label="Carga Horária Total" name="total_hours" placeholder="Ex: 200" :value="old('total_hours')"
                        numeric />
                ...
                <div class="mt-8">
                    <div class="flex justify-between items-center mb-4">
                        <div>
                            ...
                            <p class="text-sm text-neutral-500">Defina as categorias de atividades complementares e
                                suas cargas horárias máximas.</p>
                        </div>
                    </div>
